...
const textStates = [
  ...
  {
    headline: "A Smart Business cria a base que a sua empresa precisa para escalar.",
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="inline-flex items-center rounded-full border border-black/5 dark:border-white/15
              ...
              <span className="w-2 h-2 text-sm rounded-full bg-accent mr-2 animate-pulse" />
          ...
          <div className="shrink-0 hidden lg:block relative">
            ...
            >
              ...
              >
                {/* 16:9 video well */}
                <div style={{ aspectRatio: "16/9" }} className="relative overflow-hidden bg-neutral-100 dark:bg-neutral-900 transition-colors">
                  <video
                    ref={videoRef}
                    ...
                    className="w-full h-full object-cover opacity-0 data-[ready=true]:opacity-100 transition-opacity duration-700"
                  />
                  {/* Inner vignette */}
                  <div
                ...
                <div className="px-5 py-3 flex items-center justify-between border-t border-black/5 dark:border-white/6">
                  <span className="text-[10px] font-medium font-mono text-neutral-400 dark:text-white/30 tracking-widest uppercase">
                    {phase < 2 ? "Antes da Smart Business" : "Depois da Smart Business"}
                  </span>
